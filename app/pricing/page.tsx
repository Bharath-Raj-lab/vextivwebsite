...
const SOCIAL_TIERS: PricingTier[] = [
  {
    ...
    inclusions: [
      ...
      "8 posts per month with branded visuals",
  ...
  },
  {
    ...
    inclusions: [
      ...
      "16 posts per month — reels, carousels & stories",
  ...
  },
  {
    ...
    inclusions: [
      "3 platforms managed (Instagram, Facebook, LinkedIn)",
      "24 posts per month across all formats",
